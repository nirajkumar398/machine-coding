...
function connectAdvanced(selectorFactory, _ref) {
  ...
  return function wrapWithConnect(WrappedComponent) {
    ...
    var selectorFactoryOptions = _extends2({}, connectOptions, {
      getDisplayName,
      methodName,
      renderCountProp,
      shouldHandleStateChanges,
    ...
    function ConnectFunction(props) {
      ...
      var renderedWrappedComponent = (0, import_react4.useMemo)(function() {
        return import_react4.default.createElement(WrappedComponent, _extends2({}, actualChildProps, {
    ...
    if (forwardRef) {
      var forwarded = import_react4.default.forwardRef(function forwardConnectRef(props, ref2) {
        return import_react4.default.createElement(Connect, _extends2({}, props, {
...
function defaultMergeProps(stateProps, dispatchProps, ownProps) {
  return _extends2({}, ownProps, stateProps, dispatchProps);
}
...
function createConnect(_temp) {
  ...
  return function connect(mapStateToProps, mapDispatchToProps2, mergeProps, _ref2) {
    ...
    return connectHOC(selectorFactory, _extends2({
